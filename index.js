...
let smoother = ScrollSmoother.create({
  ...
  normalizeScroll: {
    allowNestedScroll: ".bn-mobilenav"
  },
  smooth: 2,
  smoothTouch: 0.1,
  preventDefault: true
...
const onReady = () => {
  ...
  const homeInfiniteSelectors = {
    ...
    redDots: '.bn-bgwrap .bn-streak-line .red-dot'
  };
  ...
  // Variables to track active slide
  ...
  function initializeScrollTrigger() {
    if (window.innerWidth > 768) {
      ScrollTrigger.create({
        ...
        // },
        // onEnterBack: (self) => {
        //   gsap.to(self.trigger, { marginTop: "100px", duration: 0.3 });
        // },
        onLeaveBack: (self) => {
          gsap.to(self.trigger, { marginTop: "0px", duration: 0.3 });
        },
